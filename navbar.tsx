  ...
  return (
    <div className=" text-black bg-white">
        <nav className="bg-white border-gray-200 fixed">
          <div className="w-screen flex flex-wrap justify-between mx-auto p-4">
            <div className="" id="navbar-cta">
              <div>
                <ul className="flex flex-col mt-4 rtl:space-x-reverse md:flex-row">
                  <li>
